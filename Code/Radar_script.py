"""
Script for running the main radar plot seen here
-- Animation referenced as (Fig 0) in the blogpost
-- Link to animation: https://www.veed.io/view/e029dd5b-08ac-4226-ba46-ffbc0060cf67?panel=share&sharingWidget=true
-- Description: Example of more complex animation created using Plotly.
"""

# import plotly.io as pio
# pio.renderers.default = "notebook" ## Render as notebook if needed
import pandas as pd
import ast
import re
